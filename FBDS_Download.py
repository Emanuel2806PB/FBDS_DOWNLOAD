# ================================================================
# Bibliotecas necessárias (instale manualmente caso não possua):
# pip install requests
# pip install beautifulsoup4
#
# Estas bibliotecas são opcionais no sentido de que o usuário
# pode instalá-las conforme necessidade. O script depende delas
